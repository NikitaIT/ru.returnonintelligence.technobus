...
public class GoogleConnectionServiceImpl implements GoogleConnectionService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(GoogleConnectionServiceImpl.class);

	private static final String CLIENT_SECRETS = "/client_id.json";
	...
	public GoogleConnectionServiceImpl() {
		LOGGER.debug("google connection");
	}
