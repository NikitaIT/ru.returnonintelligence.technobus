package ru.returnonintelligence.technobus.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "ru.returnonintelligence.technobus.repository",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "ru.returnonintelligence.technobus.domain" });
